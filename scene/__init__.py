...
class Scene_Eval:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=False,
                 resolution_scales=[1.0], logger=None):
        """b
        :param path: Path to colmap scene main folder.
        """
        self.model_path = args.model_path
        ...
        scene_info = sceneLoadTypeCallbacks["ColmapEval"](args.source_path, args.images, args.man_trans,
                                                          args.model_path)
        ...
        for resolution_scale in resolution_scales:
            ...
            print("Loading Test Cameras")
            self.test_cameras[resolution_scale] = cameraList_from_camInfosEval(scene_info.test_cameras,
