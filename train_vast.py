    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            training_report(tb_writer, iteration, Ll1, loss, l1_loss, iter_start.elapsed_time(iter_end),
                            testing_iterations, scene, render, (pipe, background), logger=logger)
            ...
            if iteration < opt.densify_until_iter:
                ...
                if iteration % opt.opacity_reset_interval == 0 or (dataset.white_background and iteration == opt.densify_from_iter):
                    gaussians.reset_opacity_features()
...
def parallel_local_training(gpu_id, partition_id, lp_args, op_args, pp_args, test_iterations, save_iterations,
    ...
    training(lp_args, op_args, pp_args, test_iterations, save_iterations, checkpoint_iterations, start_checkpoint,
             debug_from, logger=logger)
