...
Good day. Using implicit methods to reconstruct TDOM can make a meaningful thing. Below is the experimental version of the code we utilized. While it hasn’t been very elegant and meticulously organized yet, we are still more than happy to share it with you. If this resource proves helpful for graduate students and researchers working on similar projects, it would be great.
...
That's all. Wishing you all the best. 
